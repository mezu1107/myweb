      ...
      {open && (
        <div className="lg:hidden border-t border-border bg-background">
          <div className="container mx-auto py-4 flex flex-col gap-1">
            ...
            <Button asChild className="gradient-cta text-primary-foreground mt-2 w-full"><Link to={siteConfig.cta.bookNow} onClick={() => setOpen(false)}><Calendar className="w-4 h-4 mr-2" /> Book Free Call</Link></Button>
          </div>
        </div>
      )}
    </header>
